#!/usr/bin/env python3
"""List or run developer numerical checks, retaining failures and their logs."""
...
def main() -> int:
    ...
    if args.list or not (args.all or args.features):
        ...
        print("\nSee validation/models/README.md for inputs, reference results and full recalculation.")
        return 0
