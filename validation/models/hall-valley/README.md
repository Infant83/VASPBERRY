...
```bash
python3 validation/models/hall-valley/run.py --output-dir results/example-hall
```
...
[standalone CSV plotter](../../../examples/kubo/plot_hall.py) for other scan or plotting
