"""Publish version 1.4.2 only after validation of this exact source commit."""
import json
import os
...
TAG = 'v' + VERSION
PREVIOUS_TAG = 'v1.4.1'
PREVIOUS_COMMIT = 'be1fa69de75d17ffde08b6b05510ddee0bb18fc6'
CHECKS = {
    'ci.yml': frozenset({
...
def validate_metadata():
    ...
    for path in ('docs/VALIDATION_1.4.2.md', 'docs/releases/v1.4.2.md',
...
def publish(target, checks):
    ...
    payload = {
        ...
        'name': 'VASPBERRY 1.4.2 — portable native installation and reliable rebuilds',
        'body': release_body(Path('docs/releases/v1.4.2.md'), target, checks),
