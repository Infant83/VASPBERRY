"""Publish version 1.4.1 only after validation of this exact source commit."""
import json
import os
...
TAG = 'v' + VERSION
PREVIOUS_TAG = 'v1.4.0'
PREVIOUS_COMMIT = '69171571bbf2dbe963610f9648a06c7ca57d85b4'
CHECKS = {
    'ci.yml': frozenset({
...
def release_body(path, target, checks):
    ...
    text += '\nAll three workflows checked this exact release commit. Historical material-convergence studies retain their original provenance.\n'
    return text
...
def validate_metadata():
    ...
    for path in ('docs/VALIDATION_1.4.1.md', 'docs/releases/v1.4.1.md',
...
def publish(target, checks):
    ...
    payload = {
        ...
        'name': 'VASPBERRY 1.4.1 — Intel MPI and clear data-to-figure workflows',
        'body': release_body(Path('docs/releases/v1.4.1.md'), target, checks),
