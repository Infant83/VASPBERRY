...
python3 examples/features/z2/run.py --output-dir results/feature-z2
```

The directory must be new. [input.json](input.json) names and hash-binds the
existing [Bi schema-2 field](../../Bi_Z2/reference-v1.2.0-12x12/Z2_FIELD.csv);
...
[Bi provenance](../../Bi_Z2/README.md) and
